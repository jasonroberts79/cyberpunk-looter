...
class TestMemorySystemInit:
    ...
    def test_init_default_filename(self, mock_storage_class):
        ...
        memory = MemorySystem(mock_storage_instance, AppConfig())
    ...
    def test_init_custom_filename(self, mock_storage_class):
        ...
        config = AppConfig()
        config.memory.long_term_storage_file = "custom_memory.json"
        memory = MemorySystem(mock_storage_instance, config)        
    ...
    def test_init_loads_existing_memory(self, mock_storage_class):
        ...
        mock_storage_instance = Mock()
        mock_storage_instance.read_data.return_value = json.dumps(test_data)
        mock_storage_class.return_value = mock_storage_instance
...
class TestLongTermMemory:
    ...
    def test_update_long_term_new_user(self, mock_storage_class):
        ...
        mock_storage_instance.write_data.assert_called()
...
class TestPersistence:
    ...
    def test_save_long_term_memory(self, mock_storage_class):
        ...
        assert mock_storage_instance.write_data.called
        call_args = mock_storage_instance.write_data.call_args[0]
    ...
    def test_load_long_term_memory_error(self, mock_storage_class):
        ...
        mock_storage_instance = Mock()
        mock_storage_instance.read_data.side_effect = Exception("Storage error")
        mock_storage_class.return_value = mock_storage_instance
