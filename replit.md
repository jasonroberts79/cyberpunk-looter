...
## Overview
An intelligent Discord bot that uses Retrieval-Augmented Generation (RAG) with short and long-term memory capabilities. The bot answers questions based on a markdown knowledge base and maintains conversation context across sessions.

## Features
- **RAG System**: Semantic search over markdown documents using ChromaDB
...
4. **Knowledge Base** (`knowledge_base/`): Directory containing markdown documents
...
2. Add markdown files to `knowledge_base/` directory
3. Run `python bot.py`
